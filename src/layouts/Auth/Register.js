...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setMessage("Registration successful! Welcome to Minible.");
    setError(""); // Limpiar error si el registro es exitoso
                  ...
                  <div className="p-2 mt-4">
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className="form-check">
                        ...
                        Acepto <a href="#" className="text-reset">Términos y Condiciones</a>
                        </label>
                      </div>
                      ...
                      <div className="mt-4 text-center">
                        ...
                        ¿Ya tienes una cuenta?   <Link to="/Login" className="fw-medium text-primary">Iniciar Sesión</Link>
                        </p>
                      </div>
                    </form>
                  </div>
