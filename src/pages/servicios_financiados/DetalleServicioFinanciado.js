...
const DetalleServicioFinanciado = () => {
  ...
  if (loading) {
    return <p>Cargando servicio financiado...</p>;
  }

  if (error) {
    return <p>Error al cargar servicio financiado: {error.message}</p>;
  }

  if (!servicio) {
    return <p>Servicio financiado no encontrado.</p>;
  }
              ...
              <div className="row">
                <div className="col-sm-6">
                  ...
                  < p className="font-size-16 mb-4">{servicio.descripcion}</p>
                    ...
                    <p className="font-size-18 mb-2">
                      {servicio.cliente_id?.nombre}
                    </p>
                ...
                <div className="col-sm-6">
                  <div className="text-muted text-sm-end">
                    <div>
                      ...
                      <p className="font-size-16 mb-5">{new Date(servicio.fecha_inicio).toLocaleDateString()}</p>
                    </div>
                    ...
                    {servicio.fecha_termino && (
                      <div className="mt-4">
                        ...
                        <p className="font-size-16 mb-5">
                          {new Date(servicio.fecha_termino).toLocaleDateString()}
                        </p>
                      </div>
                    )}
                  </div>
              ...
              <div className="py-2">
                ...
                <div className="d-print-none mt-4">
                  ...
                  <div className="float-end">
                    ...
                    <Link
                      href="#"
                      className="btn btn-primary w-md waves-effect waves-light p-2">
                      Enviar
                    </Link>
                  </div>
                </div>                  
